var level3 ={
	...
	game.load.image("dulo","img/l2.png");
	game.load.image("tree","img/l3.png");
    ...
    create:function() {
		...
		dulo = game.add.sprite(800,10,"dulo");
    ...
    update:function() {
    	...
    	game.physics.arcade.overlap(bullets,atback,s2);
	...
	function fireBullet()
{
        ...
        function s2(bullets,atback)
{
	alert.text = "RESTART!!";
	next = game.add.button(350,300,"retry",retry2);
